        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php echo remove_junk($result['total_saleing_price'] != null ? $result['total_saleing_price'] : 0);?></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
         ...
         <tr class="text-right">
           ...
           <td> Rwf<?php echo number_format(total_price($results)[1], 2);?></td>
         </tr>
        </tfoot>
      </table>
    </div>
